...
export default function GameBoard() {
  ...
  return (
  return (
    <div className="flex flex-col h-full sm:h-screen p-1 sm:p-2 overflow-hidden bg-[url('/background.png')] bg-cover bg-center">
      {/* Status bar */}
      ...
      <div className="flex-1 flex flex-col sm:grid sm:grid-cols-[auto_1fr_auto] sm:grid-rows-[auto_1fr_auto] gap-1 min-h-0 relative">
        {/* North (top center) - Opponent 2 */}
        <div className="sm:col-start-2 sm:row-start-1 flex justify-center items-start pt-1 order-1 sm:order-none">
          <PlayerHand
            player={northPlayer}
            position="north"
        ...
        {/* Middle Row Container for Mobile */}
        <div className="flex items-center justify-between w-full px-2 py-2 sm:contents order-2 sm:order-none flex-1">
          {/* West (left middle) - Opponent 1 */}
          <div className="sm:col-start-1 sm:row-start-2 flex items-center justify-center px-1">
            <PlayerHand
              player={westPlayer}
              position="west" // On mobile we might want to override this to 'north' style if we want them horizontal? No, side is fine if scaled.
          ...
          <div className="sm:col-start-2 sm:row-start-2 flex items-center justify-center">
            <div className="flex items-center gap-2 sm:gap-6 transform scale-90 sm:scale-100 origin-center">
              {/* Draw Pile */}
              <motion.div
                className="relative"
            ...
            {/* East (right middle) - Opponent 3 */}
            <div className="sm:col-start-3 sm:row-start-2 flex items-center justify-center px-1">
              <PlayerHand
                player={eastPlayer}
                position="east"
          ...
          <div className="sm:col-start-2 sm:row-start-3 flex justify-center items-end pb-1 order-3 sm:order-none mt-auto">
            <PlayerHand
              player={southPlayer}
              position="south"
